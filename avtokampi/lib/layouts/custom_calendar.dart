...
class CustomCalendarView extends StatefulWidget {
    const CustomCalendarView({Key key,
    ...
    void setListOfDate(DateTime monthDate) {
        ...
        if (newDate.weekday < 7) {
            ...
            for (int i = 1; i <= previousMothDay; i++) {
                dateList.add(
                    newDate.subtract(Duration(days: previousMothDay - i)));
            }
        }
                                            ...
                                            child: Material(
                                                ...
                                                child: Padding(
                                                    padding: EdgeInsets.only(
                                                        top: 2,
                                                        bottom: 2,
                                                        left: isStartDateRadius(
                                                            date) ? 4 : 0,
                                                        right: isEndDateRadius(
                                                            date) ? 4 : 0),
                                                    child: Container(
                                                        decoration: BoxDecoration(
                                                            color: startDate !=
                                                ...
                                                child: Padding(
                                                    ...
                                                    child: Container(
                                                        decoration: BoxDecoration(
                                                            ...
                                                            boxShadow: getIsItStartAndEndDate(
                                                                date)
                                                                ? <BoxShadow>[
                                                                BoxShadow(
                                                                    color: Colors
                                                            ...
                                                            child: Text(
                                                                ...
                                                                style: TextStyle(
                                                                    ...
                                                                    MediaQuery
                                                                        ...
                                                                        ? 18
                                                                        : 16,
                                                                    fontWeight: getIsItStartAndEndDate(
                                                                        date)
                                                                        ? FontWeight
                                                                        .bold
                                                                        : FontWeight
