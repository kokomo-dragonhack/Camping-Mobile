...
class _MealsListViewState extends State<MealsListView>
    ...
    void initState() {
        ...
        super.initState();
        mealsListData = MealsListData.getMnenjaForUporabnik();
    }
                ...
                return FadeTransition(
                    ...
                    child: Transform(
                        transform: Matrix4.translationValues(
                            0.0, 30 * (1.0 - widget.mainScreenAnimation.value),
                            0.0),
                        child: Container(
                            height: 216,
